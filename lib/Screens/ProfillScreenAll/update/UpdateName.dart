...
class UpdatenameScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Updatenamescreen();
}
    ...
    try {
      _auth.authStateChanges().listen((User? user) async {
        ...
        if (user != null) {
          ...
          setState(() {
            _userName = userDoc['nom_usr'] ?? '';
            nomController.text = _userName;
  ...
  Future<void> _updateUserName() async {
    if (_currentUser != null) {
      ...
      try {
        ...
        _showSuccessFlushbar("le nom a ete modifie avec success");
